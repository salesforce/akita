...
export abstract class AkitaPlugin<E = any, S = any> {
  ...
  /** This method is responsible for getting an access to the query */
  protected getQuery(): Queries<E, S> {
    return this.query;
  }

  /** This method is responsible for getting an access to the store */
  protected getStore() {
  ...
  /** This method is responsible for providing whether we the plugin is entityBased or not  */
  protected isEntityBased(entityId: ID) {
    return toBoolean(entityId);
  }

  /** This method is responsible for getting the source, the whole store or one entity */
  ...
  /** This method is responsible for updating the store or one entity */
