 ...
 */
export function getEntityStore<TEntityStore extends EntityStore<S>, S = TEntityStore extends EntityStore<infer T, any, any> ? T : never>(storeClass: Constructor<TEntityStore>): TEntityStore {
 ...
 */
export function getEntityStoreByName<TEntityStore extends EntityStore<S>, S = TEntityStore extends EntityStore<infer T, any, any> ? T : never>(storeName: string): TEntityStore {
 ...
 *
 */
export function runEntityStoreAction<TEntityStore extends EntityStore<S>, S = TEntityStore extends EntityStore<infer T, any, any> ? T : any>(
