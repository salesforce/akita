...
@Component({
  template: `
    <div class="container">
      <div infiniteScroll [infiniteScrollDistance]="0.1" [infiniteScrollThrottle]="50" (scrolled)="getMore()">
        <div class="alert alert-info pointer" (click)="resetNewTweets()" *ngIf="newTweetsCount$ | async as newTweetsCount">See {{ newTweetsCount }} new Tweets</div>
...
export class TweetsComponent implements OnInit, OnDestroy {
  ...
  constructor(private tweetsQuery: TweetsQuery, private tweetsService: TweetsService) {}
