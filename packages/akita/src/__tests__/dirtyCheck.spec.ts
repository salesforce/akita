...
describe('DirtyCheck', () => {
  ...
  describe('Watch specific property', () => {
    ...
    it('should only reset the watched property', () => {
      ...
      dirtyCheck.reset();
      expect(spy).toHaveBeenLastCalledWith(false);
      expect((widgetsStore as any).entities[1]).toBeDefined();
      expect((widgetsStore as any).entities[2]).toBeDefined();
  ...
  describe('Watch entities with deepEqual', () => {
    ...
    it('should work as expected', () => {
      ...
      dirtyCheck.reset();
      expect(spy).not.toHaveBeenCalled();
      expect((widgetsStore as any).entities).toEqual({ '1': { id: 1, title: 'Widget 1' }, '2': { id: 2, title: 'Widget 2' } });
  ...
  describe('Watch 2 props with deepEqual', () => {
    ...
    it('should work as expected', () => {
      ...
      expect((widgetsStore as any).entities).toEqual({ '1': { id: 1, title: 'Widget 1' }, '2': { id: 2, title: 'kazaz widget' } });
    });
  });
});
